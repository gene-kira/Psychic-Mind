...
DEFAULT_ORGANS = [
    ...
    "guardian", "planner", "executor", "analyst"
]
DEFAULT_LANES = [
...
ENCRYPTION_KEY = b"mythic_shared_key"
            ...
            if msg:
                ...
                for out in agent_outputs:
                    ...
                    if target_node and target_node in NODES:
                        ...
                        if neighbors:
                            target = random.choice(neighbors)
                            self.send_to_neighbor(target, out)
...
class SwarmGUI:
    def __init__(self, root, node_procs):
        ...
        root.title("Mythic Distributed Brain / Guardian / Automation / Multi-Agent Swarm (A–G)")
