#!/usr/bin/env python3
# Borg‑OS Visualization Generator
# Generates multiple PNGs in the same directory.
...
if __name__ == "__main__":
    print("Generating all Borg‑OS visualization PNGs...")
    ...
    print("All PNGs generated successfully in the current directory.")
