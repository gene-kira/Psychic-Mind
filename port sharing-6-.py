...
#!/usr/bin/env python3
"""
Unified Autonomous Swarm Port Guardian
...
- Extra self-healing automation (auto-unblock ports, auto-relax rules on repeated false positives)
"""
...
SANDBOX_CPU_PERCENT_LIMIT = 50  # soft target
...
def ml_style_threat_score(event):
    ...
    if history_factor > 3:
        score -= WEIGHT_HISTORY  # repeated false positives → reduce severity
    return max(score, 0)
    ...
    while True:
        try:
            ...
            with lock:
                ...
                # distributed baseline merge (union)
