...
"""
GUARDIAN SENTINEL - TIER-4 DEFENSIVE ORGANISM
---------------------------------------------
...
3) ML Training Schema mode:
   - Decrypts logs
   - Exports shell events dataset CSV
...
def derive_fernet_key(raw: bytes) -> bytes:
    ...
    return base64.urlsafe_b64encode(h)  # 44 bytes, valid Fernet key
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["guardian", "etw-agent", "export-ml-dataset"], default="guardian")
