...
# - Local network scanner + rogue IP detection
...
class PersistentState:
    ...
    def _evaluate_lan_host_risk(self, host):
        ...
        # Aggressive: new host is suspicious until proven otherwise
        try:
        ...
        # If IP also has high risk in ip_ledger, amplify
...
# -----------------------------
# 8. Local network scanner + auto-blocker
# -----------------------------
...
class LocalNetworkScanner(threading.Thread):
    ...
    def scan_once(self):
        # Simple ARP-based scan using OS tools; defensive only.
        ...
        for line in out.splitlines():
            ...
            if "(" in line and ")" in line:
                # Format: ? (192.168.1.1) at aa:bb:cc:dd:ee:ff ...
                try:
    ...
    def _block_ip_local(self, ip, os_name):
        # Defensive: block traffic to/from this IP on local firewall.
        if os_name == "windows":
            cmd = [
            ...
            # iptables example; adjust for nftables if needed
            ...
            # macOS pf: we log the intent; actual pf rules may need manual integration
            append_log({
