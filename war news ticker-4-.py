...
def generate_risk_explanation(stress, sentiment_score, headline_count, risk_label):
    parts = []
...
class HormuzCockpit(tk.Tk):
    ...
    def _build_ui(self):
        ...
        # RIGHT: news feed + summaries + map overlay
        ...
        overlay_label = tk.Label(
            overlay_frame,
            text="Quick access overlay for Strait of Hormuz region.\nOpens a focused map window.",
            fg="#cccccc",
            bg="#101018",
            font=("Segoe UI", 9),
            justify="left",
    ...
    def open_map_overlay(self):
        ...
        win.title("Strait of Hormuz Map Overlay")
        win.geometry("600x200")
        win.configure(bg="#101018")

        lbl = tk.Label(
            win,
            text="Map Overlay: Strait of Hormuz region.\nThis opens an external maritime map focused on tanker traffic.",
            fg="#ffffff",
            bg="#101018",
            font=("Segoe UI", 10),
            justify="left",
        ...
        btn = tk.Button(
            win,
            text="Open MarineTraffic (Browser)",
            command=self.open_tanker_map,
            bg="#202040",
            fg="#00ffcc",
            font=("Segoe UI", 10, "bold"),
    ...
    def export_report(self):
        ...
        try:
            with open(filename, "w", encoding="utf-8") as f:
                f.write("Strait of Hormuz Impact Report\n")
    ...
    def refresh_news(self):
        ...
        explanation = generate_risk_explanation(
            stress, sentiment_score, len(self.news_headlines), risk_label
        )
