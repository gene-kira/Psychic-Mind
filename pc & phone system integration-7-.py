...
# ---------------------------------------------------------------------------
# CONTROLLER SIDE: Swarm manager + AUTONOMY
# ---------------------------------------------------------------------------
...
LOCAL_JOBS = [
    ...
    # Example AI job (disabled by default, enable when model is present)
    # {
    #     "name": "periodic_ai_yolo",
    #     "interval": 60.0,
    #     "last_run": 0.0,
    #     "command": "ai_infer",
    #     "payload": {
    #         "model": "yolo",
    #         "input_type": "image_b64",
    #         "input": None,
    #         "params": {"conf_threshold": 0.4},
    #     },
    # },
]
            ...
            if now - job["last_run"] >= job["interval"]:
                ...
                try:
                    if cmd == "sensors_read":
                        ...
                        if input_type == "image_b64" and input_data is None:
                            tmp = "/data/data/com.termux/files/home/autonomy_cam.jpg"
                        ...
                        logger.debug("[agent-autonomy] ai_infer(%s) -> %s", model, post)
                except Exception as e:
