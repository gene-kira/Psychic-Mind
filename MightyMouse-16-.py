...
# =========================
# GUI COCKPIT (UPDATED: WEB ALWAYS POPULATED, LOG PANEL RESTORED)
# =========================
...
class CockpitGUI(QWidget):
    def __init__(self, orch, hud, web, fs, game, profiles, memory):
        ...
        self.web_reasons_view.setPlainText(
            "Waiting for web URL...\n"
            "Use DevTools port 9222 or POST /url on 8787."
        )
        ...
        # RESTORED: System Log panel at the very bottom (dark, always filled)
    ...
    def update_gui(self):
        ...
        # --- WEB PANEL: FORCE EVALUATE WHEN URL EXISTS ---
        if self.web.latest_url:
            # Always evaluate here so the box is never empty when a URL is present
