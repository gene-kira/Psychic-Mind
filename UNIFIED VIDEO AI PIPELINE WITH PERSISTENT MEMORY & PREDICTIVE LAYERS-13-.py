#!/usr/bin/env python3
# rebootcore_async_omega_plus.py
#
# RebootCore – ASYNC OMEGA+ UNIFIED RUNTIME
# - Async scheduler (asyncio main loop)
# - Upgraded DQN training (epsilon-greedy, better target updates)
# - Real 3D renderer (moderngl + glfw) with simple camera orbit
...
# =========================
# RL AUTOPILOT – DQN STYLE + TRAINING (UPGRADED)
# =========================
...
class RLCore:
    ...
    def select_action(self, state: Dict[str, Any]) -> Dict[str, float]:
        if not self.enabled:
