    ...
    def __init__(self):
        self.data = {
            "web": {
                ...
                "avg_score": 0.0,
                "samples": 0,
                "trusted_ips": {},  # domain -> list of IPs (auto-learn)
                "domain_stats": {}  # domain -> {good_sessions, bad_sessions, avg_score}
            },
            ...
            "game": {
                ...
                "trusted_servers": {},   # game_name -> [ip1, ip2, ...]
...
class GameCognition:
    def __init__(self, hud, memory, recorder, predictor):
        ...
        self.danger_history = []  # for predictive modeling
...
class CockpitGUI(QWidget):
    def __init__(self, orch, hud, web, fs, game, profiles, memory):
        ...
        self.setWindowTitle("Mighty Mouse – Autonomous Tactical HUD (Predictive + Trust)")
