...
class LearnedPolicy:
    """
    Tiny online learner with sequence memory:
    - Features: sequence of cpu/mem + time-of-day flags
    ...
    def __init__(self, history_len: int = 5, lr: float = 0.01):
        ...
        # features: cpu_seq (h), mem_seq (h), hour_norm, is_rush, is_off
...
class QueenCore:
    ...
    def _ai_loop(self):
        while self._running:
            ...
            # Learned policy with sequence memory
