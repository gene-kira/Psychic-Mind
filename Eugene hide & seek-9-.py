...
class OrganismLoop(threading.Thread):
    ...
    def run(self):
        while self.running:
            ...
            # (optional) you could auto-follow consensus here; we keep it advisory:
            # if consensus["lockdown_vote"] and not lockdown: ...
            # if not consensus["autonomous_vote"] and autonomous: ...
